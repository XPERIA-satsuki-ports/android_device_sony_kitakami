...
KERNEL_TOOKCHAIN := prebuilts/gcc/${HOST_OS}-x86/aarch64/aarch64-linux-android-${KERNEL_TOOLCHAIN_VERSION}-kernel/bin
...
MR_KEXEC_DTB := true
MR_FSTAB := device/sony/kitakami/rootdir/twrp.fstab
